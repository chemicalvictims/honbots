...
local function HarassHeroExecuteOverride(botBrain)
	...
	if not bActionTaken and bCanSee and nLastHarassUtility > botBrain.nShockwaveThreshold then
		...
		local abilShockwave = skills.abilShockwave
		-- Get Shockwave range and add additional distance so that it won't try to ult when it's just on the border
		local nShockwaveRange = abilShockwave:GetRange() + 70
		-- Define Shockwave range squared
		local nShockwaveCloseDistanceSq = nShockwaveRange * nShockwaveRange
